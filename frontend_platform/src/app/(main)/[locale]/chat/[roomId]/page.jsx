    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                router.push(withLocale(routeLocale, '/chat'));
            }
        })();
        ...
        <div className={styles.shell}>
            <div className={styles.card}>
                <div className={styles.topBar}>
                    <Link
                        href={withLocale(routeLocale, '/chat')}
                    ...
                    {peer?.username ? (
                        <Link href={withLocale(routeLocale, `/user/${encodeURIComponent(peer.username)}`)} className={styles.peer}>
                            <Avatar
                                user={{
