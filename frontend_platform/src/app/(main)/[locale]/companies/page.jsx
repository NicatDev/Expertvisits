...
const CompanyLogo = ({ company, companyHref }) => {
    const [imgError, setImgError] = useState(false);

    return (
        <Link href={companyHref} className={styles.logoLink}>
...
export default function CompaniesPage() {
    ...
    const resolveCompanyHref = (slug) => withLocale(pathLocale, `/companies/${slug}`);
                        ...
                        {companies.length > 0 ? companies.map(company => {
                            ...
                            >
                                <div className={styles.cardHeader}>
                                    {/* Logo Link to Detail */}
                                    <CompanyLogo company={company} companyHref={resolveCompanyHref(company.slug)} />

                                    <div className={styles.info}>
                                        {/* Name Link to Detail */}
                                        <Link href={resolveCompanyHref(company.slug)} className={styles.nameLink}>
                                            <h3>{company.name}</h3>
                                        </Link>
                                ...
                                <Link href={resolveCompanyHref(company.slug)} className={styles.viewBtn}>
