...
import styles from '../profile.module.scss'; // Assuming we keep using the parent's styles or shared styles
...
const Section = ({ title, items, isOwner, onAdd, onEdit, onDelete, renderItem }) => {
    ...
    return (
        <div className={styles.section}>
            ...
            {items.length === 0 && <p style={{ color: '#999', fontStyle: 'italic' }}>{t('profile.section_helper.no_items')}</p>}
        </div>
    );
};
