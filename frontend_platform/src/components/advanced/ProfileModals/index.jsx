...
export const SkillModal = ({ isOpen, onClose, initialData, onSave }) => {
    ...
    useEffect(() => {
        if (initialData) setFormData(initialData);
        else setFormData({ name: '', skill_type: 'hard' });
    }, [initialData, isOpen]);
    ...
    return (
        <FormModal isOpen={isOpen} onClose={onClose} title={initialData ? "Edit Skill" : "Add Skill"} onSubmit={handleSubmit} loading={loading}>
