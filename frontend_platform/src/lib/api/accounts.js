...
export const accounts = {
    getUser: (username) => api.get(`accounts/users/${encodeURIComponent(username)}/`),
    updateProfile: (username, data) => api.patch(`accounts/users/${encodeURIComponent(username)}/`, data),
