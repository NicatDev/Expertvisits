...
import { Mail, MapPin, Phone, Award, GraduationCap, Briefcase, Globe, ArrowRight, Gamepad2, Trophy } from 'lucide-react';
                    ...
                    <div className={styles.heroGrid}>
                        <div className={styles.heroContent}>
                            ...
                            <h1 className={styles.heroName}>
                                <span className={styles.titlePrefix} aria-hidden>[ </span>
                                {fullName}
                                <span className={styles.titlePrefix} aria-hidden> ]</span>
                            </h1>
