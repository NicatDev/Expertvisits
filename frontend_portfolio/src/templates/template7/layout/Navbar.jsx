                   ...
                   <div className={styles.topBarContent} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                       ...
                       <div className={styles.langSwitcher} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                           <button 
                               ...
                               style={{ background: 'none', border: 'none', color: currentLang === 'az' ? 'var(--t7-primary)' : '#fff', cursor: 'pointer', fontSize: '0.8rem', fontWeight: currentLang === 'az' ? '700' : '400', transition: 'all 0.2s' }}
                           >AZ</button>
                           <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.7rem' }}>|</span>
                           <button 
                               onClick={() => toggleLanguage('en')} 
                               style={{ background: 'none', border: 'none', color: currentLang === 'en' ? 'var(--t7-primary)' : '#fff', cursor: 'pointer', fontSize: '0.8rem', fontWeight: currentLang === 'en' ? '700' : '400', transition: 'all 0.2s' }}
                           >EN</button>
                       </div>
                   </div>
               </div>
                        ...
                        <ul>
                            ...
                            <li className={styles.mobileLangSw}>
                                <div style={{ display: 'flex', gap: '12px', padding: '16px 0', borderTop: '1px solid #eee', marginTop: '8px' }}>
                                    <button onClick={() => toggleLanguage('az')} style={{ background: 'none', border: 'none', color: currentLang === 'az' ? 'var(--t7-primary)' : '#666', fontWeight: currentLang === 'az' ? '700' : '400' }}>AZ</button>
                                    <button onClick={() => toggleLanguage('en')} style={{ background: 'none', border: 'none', color: currentLang === 'en' ? 'var(--t7-primary)' : '#666', fontWeight: currentLang === 'en' ? '700' : '400' }}>EN</button>
                                </div>
                            </li>
                        </ul>
                    </div>
